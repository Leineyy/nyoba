        ...
        for (let num of participants) {
            ...
            if (anu.action == 'add' && welcomeEnabled) {
                const card = new welcomeCard()
                    ...
                    .setBackground("https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60")
...
} else if (connection === 'connecting') {console.log(color(`─[`,`magenta`),`「`,  color(`Ramdan AR`,`red`), `」`,  color(`]─`,`magenta`))
